...
enum AsterSpacing {
    static let xxs: CGFloat = 4; static let xs: CGFloat = 8; static let sm: CGFloat = 12
    static let md: CGFloat = 16; static let lg: CGFloat = 24; static let xl: CGFloat = 32
}

enum AsterRadius { static let card: CGFloat = 18; static let control: CGFloat = 10; static let chip: CGFloat = 999 }
enum AsterAnimation {
